<template>
  <div class="record">
    <div class="count-box">
      <span class="label">Gift Record</span>
      <span class="value">₱{{ user.profile.giftTotalAmount || 0 }}</span>
    </div>
    <div class="list-container">
      ...
      >
        <list
          ...
          :offset="15"
        >
          <recordList :list="cardList" type="giftRecord" :config="listConfig" />
        </list>
...
import { giftRecordListApi } from "@/api/myApi";
